...
export default function FormLayout() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-10">
      <form className="sm:mx-auto sm:max-w-7xl w-full">
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="md:flex md:items-center md:space-x-4">
                <div className="md:w-1/4">
                  <Label htmlFor="organization" className="font-medium text-white">
                    Organization
                  </Label>
                  <Select defaultValue="1">
                    <SelectTrigger
                      id="organization"
                      name="organization"
                      className="mt-2 w-full bg-white/5 border-white/20 text-white placeholder:text-white/50"
                    >
                ...
                <div className="mt-4 md:mt-0 md:w-3/4">
                  <Label htmlFor="workspace" className="font-medium text-white">
                    Workspace name
                  </Label>
                  <Input id="workspace" name="workspace" className="mt-2 bg-white/5 border-white/20 text-white placeholder:text-white/50" />
                </div>
              </div>
              <div>
                ...
                <Select defaultValue="iad1">
                  <SelectTrigger id="region" name="region" className="mt-2 bg-white/5 border-white/20 text-white placeholder:text-white/50">
            ...
            >
              {plans.map((plan) => (
                <label
                  ...
                  htmlFor={plan.name}
                  className={cn(
                    "relative block cursor-pointer rounded-md border transition",
                    selected.name === plan.name
                      ? "border-primary/20 ring-2 ring-primary/20 bg-white/5"
                ...
                >
                  ...
                  <div className="flex items-center justify-between rounded-b-md border-t border-white/20 bg-white/5 px-6 py-3">
                    <Link
                      href={plan.href}
                      className="inline-flex items-center gap-1 text-sm text-white hover:underline hover:underline-offset-4"
                    >
                      Learn more
              ...
              <CardContent>
                ...
                <ul className="mt-4 space-y-1">
                  {highlights.map((item) => (
                    <li
                      key={item.id}
                      className="flex items-center space-x-2 py-1.5 text-white"
                    >
        ...
        <div className="flex items-center justify-end space-x-4">
          <Button type="button" variant="ghost" className="text-white hover:bg-white/10 hover:text-white">
            Cancel
          </Button>
