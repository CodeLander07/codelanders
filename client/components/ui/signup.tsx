...
export const SignUp = ({ className }: SignInPageProps) => {
                ...
                <form onSubmit={handleEmailSubmit}>
                  <div className="relative">
                    <input
                      ...
                      className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-4 focus:outline-none focus:border focus:border-white/30 text-center placeholder:text-white/40"
                      required
                    />
                    {error && (
