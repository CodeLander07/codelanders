...
export const Component = () => {
  ...
  const slotClass =
    "size-[60px] md:size-14 text-lg border border-white/20 rounded-md bg-white/5 text-white";

  return (
    <Card className="flex w-full max-w-[480px] shadow-none flex-col gap-6 p-5 md:p-8 bg-black border-white/10 text-white">
      <CardHeader className="flex flex-col items-center gap-2">
        <div className="relative flex size-[68px] shrink-0 items-center justify-center rounded-full backdrop-blur-xl md:size-24 before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-b before:from-neutral-500 before:to-transparent before:opacity-10">
          <div className="relative z-10 flex size-12 items-center justify-center rounded-full bg-white/10 shadow-xs ring-1 ring-inset ring-white/20 md:size-16">
            <svg
              ...
              height="32"
              viewBox="0 0 24 24"
              className="size-6 text-white/80 md:size-8"
            >
              <path
                fill="currentColor"
        ...
        <div className="flex flex-col space-y-1.5 text-center">
          ...
          <CardDescription className="tracking-[-0.006em] text-white/70">
      ...
      <CardContent className="p-0">
        <Form {...form}>
          ...
          >
            ...
            <Separator className="mt-6 mb-2.5 bg-white/10" />
            ...
            <div className="text-sm flex items-center gap-1">
              ...
              <Button
                ...
                variant="link"
                size="sm"
                className="p-0 underline text-white/80 hover:text-white"
              >
                Resend Code
              </Button>
            </div>
